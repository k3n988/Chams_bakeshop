      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Color(0xFFFBF7F2), Color(0xFFF8F4F0)],
          ),
        ),
            ...
            child: Column(
              ...
              children: [
                if (vm.isLoading)
                  ...
                  ...vm.weeklySummaries.asMap().entries.map(
                        (e) => _WeekSummaryRow(
                          index: e.key,
                          summary: e.value,
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    '${vm.totalPiecesSold} pieces sold',
                    style: const TextStyle(
                      fontSize: 12,
                      color: Colors.white,
...
class _WeekSummaryRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isLast ? AppColors.seller.withValues(alpha: 0.20) : AppColors.border,
          ),
          boxShadow: [
            BoxShadow(
              color: Colors.black.withValues(alpha: 0.03),
        ...
        child: Row(
          children: [
            Container(
              ...
              height: 38,
              decoration: BoxDecoration(
                color: isLast ? AppColors.seller.withValues(alpha: 0.10) : AppColors.border,
                borderRadius: BorderRadius.circular(10),
              ),
            ...
            Text(
              summary.totalRemittance > 0 ? formatCurrency(summary.totalRemittance) : '₱0.00',
              style: TextStyle(
                fontSize: 14,
                fontWeight: FontWeight.w700,
                color: summary.totalRemittance > 0 ? AppColors.primaryDark : AppColors.textHint,
              ),
            ),
          ],
        ),
