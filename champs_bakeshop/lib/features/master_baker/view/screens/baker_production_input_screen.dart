    ...
    if (_validItems.isEmpty) {
      messenger.showSnackBar(SnackBar(
        content: const Row(children: [
          ...
          SizedBox(width: 8),
          Expanded(
              child: Text('Add at least one product with sacks or kg > 0')),
        ]),
        backgroundColor: AppColors.danger,
        behavior: SnackBarBehavior.floating,
        shape: RoundedRectangleBorder(
          ...
          _SectionCard(
            child: Column(
              ...
              children: [
                ...
                const _SectionLabel('BAKER INCENTIVE (IN SALARY)'),
                const SizedBox(height: 12),
                Container(
                ...
                // Bonus section
                const _SectionLabel('BONUS (PAID SEPARATELY)'),
                const SizedBox(height: 12),
                _PreviewRow(
...
class _CounterBtn extends StatelessWidget {
  ...
  Widget build(BuildContext context) => InkWell(
        ...
        child: Container(
          ...
          child: Icon(icon, size: 14, color: AppColors.masterBaker),
        ),
      );
}